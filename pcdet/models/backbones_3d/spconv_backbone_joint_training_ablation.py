...
class VoxelResBackBone8xJointTrainingAblation(nn.Module):
    ...
    def forward(self, batch_dict):
        ...
        for domain in batch_dict['batch_domains']:
            ...
            tensor_after_input_conv = getattr(self, 'conv_input_NuScenesDataset')(input_sp_tensor)
