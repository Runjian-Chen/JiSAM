...
class DatasetTemplate(torch_data.Dataset):
    ...
    def generate_prediction_dicts(self, batch_dict, pred_dicts, class_names, output_path=None):
        ...
        def generate_single_sample_dict(box_dict):
            ...
            return pred_dict
        if 'motorcycle' not in class_names:
            class_names.append('motorcycle')
        annos = []
    ...
    def prepare_data(self, data_dict):
        ...
        if data_dict.get('updated_class_names', None) is not None:
            self.class_names = data_dict.get('updated_class_names')
            data_dict.pop('updated_class_names', None)
